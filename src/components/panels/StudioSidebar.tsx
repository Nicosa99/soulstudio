...
import { Layers, CloudUpload, Settings2, Mic, Waves, Cloud, Loader2, Terminal, Blocks, Bot, Calculator, Smartphone, ArrowLeft } from "lucide-react";
...
export function StudioSidebar() {
  const [activeTab, setActiveTab] = useState<'library' | 'uploads' | 'code' | 'apps' | 'apps-freq' | 'settings'>('library');
